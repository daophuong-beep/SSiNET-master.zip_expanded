...
public class GraphPanel extends JPanel {
    ...
    private void noname1( Graphics2D g2 ) {
    ...
    private void noname2( Graphics2D g2  ) {
    ...
    private void noname3( List<Point> graphPoints, Graphics2D g2) {
    ...
    private void noname4(List<Point> graphPoints, Graphics2D g2) {
    ...
    protected void paintComponent(Graphics g) {
       ...
       this.noname2(g2);
        ...
        this.noname3(graphPoints, g2);

        g2.setStroke(oldStroke);
        g2.setColor(pointColor);
        this.noname4(graphPoints, g2);
    }
